...
2. Download the MSI file for the latest release [Releases](https://github.com/anthonylangsworth/EDMFAT/releases) at the top right. Your browser may warn you that the MSI is potentially harmful. Please ignore these warnings.
