...
4. Minor faction-relevant activity will be captured and appear in the EDMC window. EDMFAT tracks [completing missions](doc/missions.md), selling bounty vouchers, selling combat bonds, trade (positive, negative and black market), selling cartography data, failed missions and clean ship kills. EDMFAT cannot track conflict zone wins and losses due to  **Elite: Dangerous** limitations. 
