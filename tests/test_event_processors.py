...
from edmfs.event_processors import CommodityNotInLastMarketError, MarketEventProcessor, _get_event_minor_faction_impact, _get_market_entry, \
    LocationEventProcessor, RedeemVoucherEventProcessor, DockedEventProcessor, SellExplorationDataEventProcessor, MarketSellEventProcessor, \
    MarketBuyEventProcessor, MissionAcceptedEventProcessor, MissionCompletedEventProcessor, MissionAbandonedEventProcessor, \
    MissionFailedEventProcessor, CommitCrimeEventProcessor, SellOrganicDataEventProcessor
from edmfs.state import PilotState, GalaxyState, Station, Mission, StarSystem
from edmfs.event_summaries import EventSummary, RedeemVoucherEventSummary, SellExplorationDataEventSummary, MarketSellEventSummary, \
    MarketBuyEventSummary, MissionCompletedEventSummary, MissionFailedEventSummary, MurderEventSummary, SellOrganicDataEventSummary
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {"timestamp": "2020-05-09T04:43:16Z", "event": "RedeemVoucher", "Type": "bounty",
                "Amount": 42350, "Factions": [{"Faction": "The Fuel Rats Mischief", "Amount": 42350}]},
            [RedeemVoucherEventSummary(
                "Fuelum", {"The Fuel Rats Mischief"}, {}, "bounty", 42350)]
        ),
        (
            StarSystem("Fuelum", 1000, ("The Fuel Rats Mischief", "Findja Empire Assembly")),
            Station("Station", 1000, "The Fuel Rats Mischief"),
            {"timestamp": "2020-05-09T03:42:20Z", "event": "RedeemVoucher", "Type": "bounty",
                "Amount": 25490, "Factions": [{"Faction": "Findja Empire Assembly", "Amount": 25490}]},
            [RedeemVoucherEventSummary("Fuelum", {"Findja Empire Assembly"}, {
                                       "The Fuel Rats Mischief"}, "bounty", 25490)]
        ),
        (
            # Interstellar factors
            StarSystem("Findja", 1000, ("The Fuel Rats Mischief",)),
            Station("Station", 1000, "The Fuel Rats Mischief"),
            {"timestamp": "2020-05-09T03:42:31Z", "event": "RedeemVoucher", "Type": "bounty",
                "Amount": 13338, "Factions": [{"Faction": "", "Amount": 13338}], "BrokerPercentage": 25.000000},
            []
        ),
        (
            ...
            Station("Station", 1000, "The Fuel Rats Mischief"),
            {"timestamp": "2020-10-15T14:45:16Z", "event": "RedeemVoucher", "Type": "bounty", "Amount": 1779467,
                "Factions": [{"Faction": "CPD-59 314 Imperial Society", "Amount": 1779467}], "BrokerPercentage": 25.000000},
            [RedeemVoucherEventSummary("CPD-59 314", {"CPD-59 314 Imperial Society"}, {
                                       "The Fuel Rats Mischief"}, "bounty", 1779467)]
        ),
        (
            ...
            Station("Station", 1000, "The Fuel Rats Mischief"),
            {"timestamp": "2020-12-13T02:02:04Z", "event": "RedeemVoucher", "Type": "bounty", "Amount": 5924586, "Factions": [{"Faction": "Rabh Empire Pact", "Amount": 385660}, {
                "Faction": "Kacomam Empire Group", "Amount": 666873}, {"Faction": "Trumuye Emperor's Grace", "Amount": 545094}, {"Faction": "EDA Kunti League", "Amount": 4326959}]},
            [
        ...
        (
            ...
            {"timestamp": "2020-11-27T11:46:17Z", "event": "RedeemVoucher",
                "Type": "CombatBond", "Amount": 1622105, "Faction": "EDA Kunti League"},
            [RedeemVoucherEventSummary("", {"EDA Kunti League"}, {
                                       "The Fuel Rats Mischief"}, "CombatBond", 1622105)]
        ),
        (
            StarSystem("", 1000, ("The Fuel Rats Mischief", "CPD-59 314 Imperial Society")),
            Station("", 1000, "The Fuel Rats Mischief"),
            {"timestamp": "2020-10-31T14:56:09Z", "event": "RedeemVoucher",
                "Type": "CombatBond", "Amount": 1177365, "Faction": "CPD-59 314 Imperial Society"},
            [RedeemVoucherEventSummary(
                "", {"CPD-59 314 Imperial Society"}, {"The Fuel Rats Mischief"}, "CombatBond", 1177365)]
        ),
        (
            # Interstellar factors
            StarSystem("", 1000, ("The Fuel Rats Mischief",)),
            Station("", 1000, "The Fuel Rats Mischief"),
            {"timestamp": "2020-07-17T15:21:20Z", "event": "RedeemVoucher", "Type": "CombatBond",
                "Amount": 46026, "Faction": "", "BrokerPercentage": 25.000000},
            []
        ),
        (
            # Fleet carrier redemption office
            ...
            Station("", 1000, "The Fuel Rats Mischief"),
            {"timestamp": "2020-10-18T11:23:57Z", "event": "RedeemVoucher", "Type": "CombatBond",
                "Amount": 1127126, "Faction": "HR 1597 & Co", "BrokerPercentage": 25.000000},
            [RedeemVoucherEventSummary("", {"HR 1597 & Co"}, {
                                       "The Fuel Rats Mischief"}, "CombatBond", 1502835)]
        ),
        ...
        (
            ...
            Station("", 1000, "The Fuel Rats Mischief"),
            {"timestamp": "2020-07-17T15:21:20Z", "event": "RedeemVoucher", "Type": "CombatBond",
                "Amount": 1000, "Faction": "HR 1597 & Co", "BrokerPercentage": 0.000000},
            [RedeemVoucherEventSummary("", {"HR 1597 & Co"}, {
                                       "The Fuel Rats Mischief"}, "CombatBond", 1000)]
        ),
        (
            StarSystem("", 1000, ("The Fuel Rats Mischief", "HR 1597 & Co")),
            Station("", 1000, "The Fuel Rats Mischief"),
            {"timestamp": "2020-07-17T15:21:20Z", "event": "RedeemVoucher", "Type": "CombatBond",
                "Amount": 1000, "Faction": "HR 1597 & Co", "BrokerPercentage": 1.000000},
            [RedeemVoucherEventSummary("", {"HR 1597 & Co"}, {
                                       "The Fuel Rats Mischief"}, "CombatBond", 1010)]
        ),
        (
            StarSystem("", 1000, ("The Fuel Rats Mischief", "HR 1597 & Co")),
            Station("", 1000, "The Fuel Rats Mischief"),
            {"timestamp": "2020-07-17T15:21:20Z", "event": "RedeemVoucher", "Type": "CombatBond",
                "Amount": 1000, "Faction": "HR 1597 & Co", "BrokerPercentage": 99.000000},
            [RedeemVoucherEventSummary("", {"HR 1597 & Co"}, {
                                       "The Fuel Rats Mischief"}, "CombatBond", 100000)]
        ),
        (
            StarSystem("", 1000, ("The Fuel Rats Mischief", "HR 1597 & Co")),
            Station("", 1000, "The Fuel Rats Mischief"),
            {"timestamp": "2020-07-17T15:21:20Z", "event": "RedeemVoucher", "Type": "CombatBond",
                "Amount": 1000, "Faction": "HR 1597 & Co", "BrokerPercentage": 100.000000},
            [RedeemVoucherEventSummary("", {"HR 1597 & Co"}, {
                                       "The Fuel Rats Mischief"}, "CombatBond", 1000)]
        ),
        ...
        (
            StarSystem("", 1000, ("The Fuel Rats Mischief",)),
            Station("", 1000, "The Fuel Rats Mischief"),
            {"timestamp": "2020-07-05T10:26:31Z", "event": "RedeemVoucher",
                "Type": "codex", "Amount": 5000, "Faction": ""},
            []
        ),
        (
            StarSystem("", 1000, ("The Fuel Rats Mischief",)),
            Station("", 1000, "The Fuel Rats Mischief"),
            {"timestamp": "2020-12-27T07:48:49Z", "event": "RedeemVoucher",
                "Type": "settlement", "Amount": 4352, "Faction": ""},
            []
        ),
    ])
...
@pytest.mark.parametrize(
    ...
    [
        (
            {"timestamp": "2020-10-19T11:16:16Z", "event": "Docked", "StationName": "Jean City", "StationType": "Outpost", "StarSystem": "HR 1597", "SystemAddress": 869487593835, "MarketID": 3223702528, "StationFaction": {"Name": "HR 1597 & Co"}, "StationGovernment": "$government_Corporate;", "StationGovernment_Localised": "Corporate", "StationAllegiance": "Empire", "StationServices": [
                "dock", "autodock", "commodities", "contacts", "exploration", "missions", "rearm", "refuel", "repair", "tuning", "engineer", "missionsgenerated", "flightcontroller", "stationoperations", "powerplay", "searchrescue", "stationMenu"], "StationEconomy":"$economy_Refinery;", "StationEconomy_Localised":"Refinery", "StationEconomies":[{"Name": "$economy_Refinery;", "Name_Localised": "Refinery", "Proportion": 0.810000}, {"Name": "$economy_Extraction;", "Name_Localised": "Extraction", "Proportion": 0.190000}], "DistFromStarLS": 170.514980},
        ...
        (
            {"timestamp": "2020-10-19T11:27:21Z", "event": "Docked", "StationName": "Anderson Hub", "StationType": "Outpost", "StarSystem": "Kokobii", "SystemAddress": 3657399472850, "MarketID": 3223765504, "StationFaction": {"Name": "San Davokje Transport Company", "FactionState": "War"}, "StationGovernment": "$government_Corporate;", "StationGovernment_Localised": "Corporate", "StationAllegiance": "Empire", "StationServices": [
                "dock", "autodock", "commodities", "contacts", "exploration", "missions", "outfitting", "crewlounge", "rearm", "refuel", "repair", "tuning", "engineer", "missionsgenerated", "flightcontroller", "stationoperations", "powerplay", "searchrescue", "stationMenu"], "StationEconomy":"$economy_HighTech;", "StationEconomy_Localised":"High Tech", "StationEconomies":[{"Name": "$economy_HighTech;", "Name_Localised": "High Tech", "Proportion": 0.510000}, {"Name": "$economy_Refinery;", "Name_Localised": "Refinery", "Proportion": 0.490000}], "DistFromStarLS": 2990.366866},
            Station("Anderson Hub", 3657399472850,
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {"timestamp": "2020-05-15T13:13:38Z", "event": "MultiSellExplorationData", "Discovered": [{"SystemName": "Shui Wei Sector PO-Q b5-1", "NumBodies": 25}, {
                "SystemName": "Pera", "NumBodies": 22}], "BaseValue": 47743, "Bonus": 0, "TotalEarnings": 47743},
            [SellExplorationDataEventSummary("HR 1597", {"HR 1597 & Co"}, {
                                             "EDA Kunti League"}, 47743)]
        ),
        (
            StarSystem("HR 1597", 1000, ("EDA Kunti League", "HR 1597 & Co")),
            ...
            [SellExplorationDataEventSummary(
                "HR 1597", {"EDA Kunti League"}, {"HR 1597 & Co"}, 47743)]
        )
    ])
...
@pytest.mark.parametrize(
    ...
    (
        (
            ...
            {"id": 128049154, "Name": "$gold_name;", "Name_Localised": "Gold", "Category": "$MARKET_category_metals;", "Category_Localised": "Metals", "BuyPrice": 44266,
                "SellPrice": 43761, "MeanPrice": 47610, "StockBracket": 3, "DemandBracket": 0, "Stock": 80, "Demand": 1, "Consumer": False, "Producer": True, "Rare": False},
            {"timestamp": "2020-12-26T14:44:02Z", "event": "MarketSell", "MarketID": 3510023936,
                "Type": "gold", "Count": 756, "SellPrice": 59759, "TotalSale": 45177804, "AvgPricePaid": 4568},
            [MarketSellEventSummary("Afli", {"Soverign Justice League"}, {
                                    "Afli Blue Society"}, 756, 59759, 4568, 0)]
        ),
        (
            StarSystem("Afli", 1000, ("Soverign Justice League", "Afli Blue Society")),
            Station("Pu City", 1000, "Afli Blue Society"),
            {"id": 128049154, "Name": "$gold_name;", "Name_Localised": "Gold", "Category": "$MARKET_category_metals;", "Category_Localised": "Metals", "BuyPrice": 44266,
                "SellPrice": 43761, "MeanPrice": 47610, "StockBracket": 3, "DemandBracket": 2, "Stock": 80, "Demand": 1, "Consumer": False, "Producer": True, "Rare": False},
            {"timestamp": "2020-12-26T14:44:02Z", "event": "MarketSell", "MarketID": 3510023936,
                "Type": "gold", "Count": 756, "SellPrice": 59759, "TotalSale": 45177804, "AvgPricePaid": 4568},
            [MarketSellEventSummary("Afli", {"Afli Blue Society"}, {
                                    "Soverign Justice League"}, 756, 59759, 4568, 2)]
        ),
        (
            StarSystem("Afli", 1000, ("Soverign Justice League", "Afli Blue Society")),
            Station("Pu City", 1000, "Soverign Justice League"),
            {"id": 128064028, "Name": "$battleweapons_name;", "Name_Localised": "Battle Weapons", "Category": "$MARKET_category_machinery;", "Category_Localised": "Machinery",
                "BuyPrice": 205, "SellPrice": 204, "MeanPrice": 571, "StockBracket": 2, "DemandBracket": 3, "Stock": 4100, "Demand": 0, "Consumer": False, "Producer": True, "Rare": False},
            {"timestamp": "2020-10-25T13:00:41Z", "event": "MarketSell", "MarketID": 3228014336, "Type": "battleweapons", "Type_Localised": "Battle Weapons",
                "Count": 1, "SellPrice": 7111, "TotalSale": 7111, "AvgPricePaid": 0, "IllegalGoods": True, "BlackMarket": True},
            [MarketSellEventSummary("Afli", {"Afli Blue Society"}, {
                                    "Soverign Justice League"}, 1, 7111, 0, 3)]
        ),
        (
            StarSystem("Afli", 1000, ("Soverign Justice League", "Afli Blue Society")),
            Station("Pu City", 1000, "Afli Blue Society"),
            ...
            {"timestamp": "2020-10-25T13:00:41Z", "event": "MarketSell", "MarketID": 3228014336, "Type": "battleweapons", "Type_Localised": "Battle Weapons",
                "Count": 1, "SellPrice": 7111, "TotalSale": 7111, "AvgPricePaid": 0, "IllegalGoods": True, "BlackMarket": True},
            [MarketSellEventSummary("Afli", {"Soverign Justice League"}, {
                                    "Afli Blue Society"}, 1, 7111, 0, 3)]
        ),
        (
            StarSystem("Afli", 1000, ("Soverign Justice League", "Afli Blue Society")),
            Station("Pu City", 1000, "Soverign Justice League"),
            {"id": 128049202, "Name": "$hydrogenfuel_name;", "Name_Localised": "Hydrogen Fuel", "Category": "$MARKET_category_chemicals;", "Category_Localised": "Chemicals",
                "BuyPrice": 84, "SellPrice": 80, "MeanPrice": 113, "StockBracket": 3, "DemandBracket": 0, "Stock": 1103, "Demand": 1, "Consumer": False, "Producer": True, "Rare": False},
            {"timestamp": "2020-10-01T13:31:38Z", "event": "MarketSell", "MarketID": 3223702528, "Type": "hydrogenfuel",
                "Type_Localised": "Hydrogen Fuel", "Count": 64, "SellPrice": 80, "TotalSale": 5120, "AvgPricePaid": 1080},
            [MarketSellEventSummary("Afli", {"Afli Blue Society"}, {
                                    "Soverign Justice League"}, 64, 80, 1080, 0)]
        ),
        (
            StarSystem("Afli", 1000, ("Soverign Justice League", "Afli Blue Society")),
            Station("Pu City", 1000, "Soverign Justice League"),
            {"id": 128049202, "Name": "$hydrogenfuel_name;", "Name_Localised": "Hydrogen Fuel", "Category": "$MARKET_category_chemicals;", "Category_Localised": "Chemicals",
                "BuyPrice": 84, "SellPrice": 80, "MeanPrice": 113, "StockBracket": 3, "DemandBracket": 0, "Stock": 1103, "Demand": 1, "Consumer": False, "Producer": True, "Rare": False},
            {"timestamp": "2020-10-01T13:31:38Z", "event": "MarketSell", "MarketID": 3223702528, "Type": "hydrogenfuel",
                "Type_Localised": "Hydrogen Fuel", "Count": 1, "SellPrice": 80, "TotalSale": 80, "AvgPricePaid": 80},
            []
        ),
        (
            StarSystem("Afli", 1000, ("Soverign Justice League", "Afli Blue Society")),
            ...
            {"id": 128064028, "Name": "$battleweapons_name;", "Name_Localised": "Battle Weapons", "Category": "$MARKET_category_machinery;", "Category_Localised": "Machinery",
                "BuyPrice": 205, "SellPrice": 204, "MeanPrice": 571, "StockBracket": 2, "DemandBracket": 3, "Stock": 4100, "Demand": 0, "Consumer": False, "Producer": True, "Rare": False},
            {"timestamp": "2020-10-25T13:00:41Z", "event": "MarketSell", "MarketID": 3228014336, "Type": "battleweapons", "Type_Localised": "Battle Weapons",
                "Count": 1, "SellPrice": 7111, "TotalSale": 7111, "AvgPricePaid": 10000, "IllegalGoods": True, "BlackMarket": True},
            [MarketSellEventSummary("Afli", {"Afli Blue Society"}, {
                                    "Soverign Justice League"}, 1, 7111, 10000, 3)]
        )
    )
)
...
@pytest.mark.parametrize(
    ...
    (
        (
            StarSystem("Afli", 1000, ("Soverign Justice League", "Afli Blue Society")),
            Station("Pu City", 1000, "Soverign Justice League"),
            {"id": 128064028, "Name": "$atmosphericextractors_name;", "Name_Localised": "Atmospheric Processors", "Category": "$MARKET_category_machinery;", "Category_Localised": "Machinery",
                "BuyPrice": 205, "SellPrice": 204, "MeanPrice": 571, "StockBracket": 2, "DemandBracket": 0, "Stock": 4100, "Demand": 0, "Consumer": False, "Producer": True, "Rare": False},
            {"timestamp": "2020-05-09T03:09:19Z", "event": "MarketBuy", "MarketID": 3223839232, "Type": "atmosphericextractors",
                "Type_Localised": "Atmospheric Processors", "Count": 32, "BuyPrice": 385, "TotalCost": 12320},
            [MarketBuyEventSummary("Afli", {"Soverign Justice League"}, {
                                   "Afli Blue Society"}, 32, 385, 2)]
        ),
        (
            StarSystem("Afli", 1000, ("Soverign Justice League", "Afli Blue Society")),
            Station("Pu City", 1000, "Afli Blue Society"),
            {"id": 128049171, "Name": "$tantalum_name;", "Name_Localised": "Tantalum", "Category": "$MARKET_category_metals;", "Category_Localised": "Metals", "BuyPrice": 2567,
                "SellPrice": 2566, "MeanPrice": 4044, "StockBracket": 1, "DemandBracket": 0, "Stock": 22680, "Demand": 0, "Consumer": False, "Producer": True, "Rare": False},
            {"timestamp": "2021-02-21T06:34:18Z", "event": "MarketBuy", "MarketID": 3224940032,
                "Type": "tantalum", "Count": 33, "BuyPrice": 3483, "TotalCost": 111456},
            [MarketBuyEventSummary("Afli", {"Afli Blue Society"}, {
                                   "Soverign Justice League"}, 33, 3483, 1)]
        )
    )
)
...
@pytest.mark.parametrize(
    ...
    (
        (
            ...
            {"timestamp": "2020-12-31T13:47:32Z", "event": "MissionAccepted", "Faction": "Luchu Purple Hand Gang", "Name": "Mission_Courier", "LocalisedName": "Courier Job Available", "TargetFaction": "LTT 2337 Empire Party",
                "DestinationSystem": "LTT 2337", "DestinationStation": "Bowen Terminal", "Expiry": "2021-01-01T13:46:03Z", "Wing": False, "Influence": "++", "Reputation": "+", "Reward": 51607, "MissionID": 685926938}
        ),
        (
            StarSystem("Luchu", 86306249, ["Luchu Purple Hand Gang", "LHS 1832 Labour", "Noblemen of Luchu", "Movement for Luchu for Equality"]),
            Station("Neumann Enterprise", 86306249, "Luchu Purple Hand Gang"),
            Mission(685926779, "LHS 1832 Labour", "++", 86306249),
            {"timestamp": "2020-12-31T13:47:10Z", "event": "MissionAccepted", "Faction": "LHS 1832 Labour", "Name": "Chain_HelpFinishTheOrder", "LocalisedName": "Deliver 2 Units of Polymers", "Commodity": "$Polymers_Name;", "Commodity_Localised": "Polymers",
                "Count": 2, "TargetFaction": "Verner Imperial Society", "DestinationSystem": "Beatis", "DestinationStation": "Vlamingh Hub", "Expiry": "2021-01-01T13:46:03Z", "Wing": False, "Influence": "++", "Reputation": "++", "Reward": 10045, "MissionID": 685926779}
        )
    )
)
...
@pytest.mark.parametrize(
    ...
    (
        (
            ...
            {"timestamp": "2020-12-31T14:11:07Z", "event": "MissionCompleted", "Faction": "Luchu Purple Hand Gang", "Name": "Mission_Courier_name", "MissionID": 685926938, "TargetFaction": "LTT 2337 Empire Party", "DestinationSystem": "LTT 2337", "DestinationStation": "Bowen Terminal", "Reward": 11763, "FactionEffects": [{"Faction": "Luchu Purple Hand Gang", "Effects": [
                {"Effect": "$MISSIONUTIL_Interaction_Summary_EP_up;", "Effect_Localised": "The economic status of $#MinorFaction; has improved in the $#System; system.", "Trend": "UpGood"}], "Influence": [{"SystemAddress": 2871051298217, "Trend": "UpGood", "Influence": "++"}], "ReputationTrend": "UpGood", "Reputation": "+"}, {"Faction": "LTT 2337 Empire Party", "Effects": [], "Influence":[], "ReputationTrend":"UpGood", "Reputation":"+"}]},
            [
        ...
        (
            ...
            {"timestamp": "2020-04-25T15:25:27Z", "event": "MissionCompleted", "Faction": "Pilots' Federation Administration", "Name": "Mission_Delivery_name", "MissionID": 570789967, "Commodity": "$ConductiveFabrics_Name;", "Commodity_Localised": "Conductive Fabrics", "Count": 4,
                "TargetFaction": "Pilots' Federation Administration", "DestinationSystem": "Dromi", "DestinationStation": "Mawson Dock", "Reward": 24310, "FactionEffects": [{"Faction": "Pilots' Federation Administration", "Effects": [], "Influence":[], "ReputationTrend":"UpGood", "Reputation":"+"}]},
            []
        ),
        (
            [
...
@pytest.mark.parametrize(
    ...
    (
        (
            ...
            {"timestamp": "2020-05-17T04:08:53Z", "event": "MissionAbandoned",
                "Name": "MISSION_Scan_name", "MissionID": 579156136},
            [
            ]
        ),
        (
...
@pytest.mark.parametrize(
    ...
    (
        (
            [],
            [],
            {"timestamp": "2020-05-17T04:08:53Z", "event": "MissionFailed",
                "Name": "MISSION_Scan_name", "MissionID": 579156136},
            [],
            []
        ),
...
@pytest.mark.parametrize(
    ...
    (
        (
            StarSystem("Gebel", 5791537031962098456136, ["EG Union", "Gebel Silver Advanced Org", "Gebel Empire League", "Gebel Freedom Party", "Gebel Industries", "Workers of Gebel Labour", "Pilots' Federation Local Branch"]),
            {"timestamp": "2020-09-28T15:35:22Z", "event": "CommitCrime", "CrimeType": "murder",
                "Faction": "Pilots' Federation Local Branch", "Victim": "Nick Coates", "Bounty": 5000},
            [
...
@pytest.mark.parametrize(
    ...
    (
        (
            StarSystem("LHS 1832", 672028108201, ["EDA Kunti League", "Federal Defense League"]),
            Station("Coney Gateway", 672028108201, "EDA Kunti League"),
            {"timestamp": "2021-08-05T15:27:05Z", "event": "SellOrganicData",
                "MarketID": 672028108201, "BioData": []},
            [
            ]
        ),
        (
            ...
            {"timestamp": "2021-08-05T15:27:05Z", "event": "SellOrganicData", "MarketID": 672028108201, "BioData": [
                {"Genus": "$Codex_Ent_Fonticulus_Genus_Name;", "Genus_Localised": "Fonticulua",
                    "Species": "$Codex_Ent_Fonticulus_02_Name;", "Species_Localised": "Fonticulua Campestris", "Value": 63600, "Bonus": 0}
            ]},
            [
        ...
        (
            ...
            {"timestamp": "2021-08-05T12:04:21Z", "event": "SellOrganicData", "MarketID": 672028108201, "BioData": [
                {"Genus": "$Codex_Ent_Stratum_Genus_Name;", "Genus_Localised": "Stratum", "Species": "$Codex_Ent_Stratum_06_Name;",
                    "Species_Localised": "Stratum Cucumisis", "Value": 711500, "Bonus": 711500},
                {"Genus": "$Codex_Ent_Bacterial_Genus_Name;", "Genus_Localised": "Bacterium", "Species": "$Codex_Ent_Bacterial_12_Name;",
                    "Species_Localised": "Bacterium Cerbrus", "Value": 121300, "Bonus": 121300},
                {"Genus": "$Codex_Ent_Tussocks_Genus_Name;", "Genus_Localised": "Tussock",
                    "Species": "$Codex_Ent_Tussocks_04_Name;", "Species_Localised": "Tussock Cultro", "Value": 125600, "Bonus": 0},
                {"Genus": "$Codex_Ent_Bacterial_Genus_Name;", "Genus_Localised": "Bacterium",
                    "Species": "$Codex_Ent_Bacterial_06_Name;", "Species_Localised": "Bacterium Alcyoneum", "Value": 119500, "Bonus": 0},
                {"Genus": "$Codex_Ent_Tussocks_Genus_Name;", "Genus_Localised": "Tussock",
                    "Species": "$Codex_Ent_Tussocks_04_Name;", "Species_Localised": "Tussock Cultro", "Value": 125600, "Bonus": 0},
                {"Genus": "$Codex_Ent_Bacterial_Genus_Name;", "Genus_Localised": "Bacterium",
                    "Species": "$Codex_Ent_Bacterial_06_Name;", "Species_Localised": "Bacterium Alcyoneum", "Value": 119500, "Bonus": 0},
                {"Genus": "$Codex_Ent_Cactoid_Genus_Name;", "Genus_Localised": "Cactoida",
                    "Species": "$Codex_Ent_Cactoid_02_Name;", "Species_Localised": "Cactoida Lapis", "Value": 164000, "Bonus": 0},
                {"Genus": "$Codex_Ent_Tubus_Genus_Name;", "Genus_Localised": "Tubus", "Species": "$Codex_Ent_Tubus_04_Name;",
                    "Species_Localised": "Tubus Rosarium", "Value": 400500, "Bonus": 0},
                {"Genus": "$Codex_Ent_Fungoids_Genus_Name;", "Genus_Localised": "Fungoida",
                    "Species": "$Codex_Ent_Fungoids_02_Name;", "Species_Localised": "Fungoida Stabitis", "Value": 174000, "Bonus": 0},
                {"Genus": "$Codex_Ent_Tussocks_Genus_Name;", "Genus_Localised": "Tussock",
                    "Species": "$Codex_Ent_Tussocks_11_Name;", "Species_Localised": "Tussock Caputus", "Value": 213100, "Bonus": 0},
                {"Genus": "$Codex_Ent_Conchas_Genus_Name;", "Genus_Localised": "Concha",
                    "Species": "$Codex_Ent_Conchas_01_Name;", "Species_Localised": "Concha Renibus", "Value": 264300, "Bonus": 0},
                {"Genus": "$Codex_Ent_Shrubs_Genus_Name;", "Genus_Localised": "Frutexa",
                    "Species": "$Codex_Ent_Shrubs_02_Name;", "Species_Localised": "Frutexa Acus", "Value": 400500, "Bonus": 0},
                {"Genus": "$Codex_Ent_Cactoid_Genus_Name;", "Genus_Localised": "Cactoida",
                    "Species": "$Codex_Ent_Cactoid_01_Name;", "Species_Localised": "Cactoida Cortexum", "Value": 222500, "Bonus": 0},
                {"Genus": "$Codex_Ent_Bacterial_Genus_Name;", "Genus_Localised": "Bacterium",
                    "Species": "$Codex_Ent_Bacterial_12_Name;", "Species_Localised": "Bacterium Cerbrus", "Value": 121300, "Bonus": 0}
            ]},
            [
...
def test_market():
    event = {"timestamp": "2020-05-09T03:08:12Z", "event": "Market",
             "MarketID": 3223839232, "StationName": "White Enterprise", "StarSystem": "LTT 9104"}
    pilot_state = PilotState()
...
@pytest.mark.parametrize(
    ...
    (
        (
            {"timestamp": "2021-08-05T13:31:48Z", "event": "MarketSell", "MarketID": 3224806912,
                "Type": "algae", "Count": 1, "SellPrice": 28, "TotalSale": 28, "AvgPricePaid": 0},
            {"id": 128049177, "Name": "$algae_name;", "Name_Localised": "Algae", "Category": "$MARKET_category_foods;", "Category_Localised": "Foods", "BuyPrice": 27,
                "SellPrice": 26, "MeanPrice": 356, "StockBracket": 0, "DemandBracket": 0, "Stock": 0, "Demand": 0, "Consumer": False, "Producer": False, "Rare": False},
            {"DemandBracket": 0, "StockBracket": 0}
        ),
        (
            {"timestamp": "2021-02-12T08:21:35Z", "event": "MarketSell", "MarketID": 3704085504, "Type": "hydrogenfuel",
                "Type_Localised": "Hydrogen Fuel", "Count": 784, "SellPrice": 6, "TotalSale": 4704, "AvgPricePaid": 84},
            {"id": 128049202, "Name": "$hydrogenfuel_name;", "Name_Localised": "Hydrogen Fuel", "Category": "$MARKET_category_chemicals;", "Category_Localised": "Chemicals",
                "BuyPrice": 84, "SellPrice": 80, "MeanPrice": 113, "StockBracket": 3, "DemandBracket": 0, "Stock": 1103, "Demand": 1, "Consumer": False, "Producer": True, "Rare": False},
            {"DemandBracket": 0, "StockBracket": 3}
        ),
        (
            {"timestamp": "2021-02-12T12:01:19Z", "event": "MarketSell", "MarketID": 3704085504, "Type": "hydrogenfuel",
                "Type_Localised": "Hydrogen Fuel", "Count": 784, "SellPrice": 6, "TotalSale": 4704, "AvgPricePaid": 84},
            {"id": 128049177, "Name": "$algae_name;", "Name_Localised": "Algae", "Category": "$MARKET_category_foods;", "Category_Localised": "Foods", "BuyPrice": 27,
                "SellPrice": 26, "MeanPrice": 356, "StockBracket": 0, "DemandBracket": 0, "Stock": 0, "Demand": 0, "Consumer": False, "Producer": False, "Rare": False},
            None
        ...
        (
            {"timestamp": "2021-02-21T06:27:23Z", "event": "MarketBuy", "MarketID": 3224939776,
                "Type": "copper", "Count": 32, "BuyPrice": 408, "TotalCost": 13056},
            {"id": 128049175, "Name": "$copper_name;", "Name_Localised": "Copper", "Category": "$MARKET_category_metals;", "Category_Localised": "Metals", "BuyPrice": 246,
                "SellPrice": 245, "MeanPrice": 689, "StockBracket": 1, "DemandBracket": 2, "Stock": 0, "Demand": 0, "Consumer": False, "Producer": False, "Rare": False},
